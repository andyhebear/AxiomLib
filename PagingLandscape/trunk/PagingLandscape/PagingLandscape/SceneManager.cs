...
namespace Axiom.SceneManagers.PagingLandscape
{
	...
	public class SceneManager :  Axiom.Core.SceneManager
	{
		...
		///	for full details.
		/// </remarks>
		public override Axiom.Core.RaySceneQuery CreateRayQuery(Ray ray, uint mask)
		{
		...
		///	for full details.
		/// </remarks>
		public override Axiom.Core.IntersectionSceneQuery CreateIntersectionQuery(uint mask)
		{
