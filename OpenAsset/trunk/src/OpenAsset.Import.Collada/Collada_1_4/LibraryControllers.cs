...
[XmlRootAttribute(Namespace="http://www.collada.org/2005/11/COLLADASchema", IsNullable=false, ElementName="library_controllers")]
public partial class LibraryControllers : ColladaBase {
    
    private Asset assetField;
    
    private List<Controller> controllerField;
