...
[XmlRootAttribute(Namespace="http://www.collada.org/2005/11/COLLADASchema", IsNullable=false, ElementName="library_physics_models")]
public partial class LibraryPhysicsModels : ColladaBase {
    
    private Asset assetField;
    
    private List<PhysicsModel> physics_modelField;
