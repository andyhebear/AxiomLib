	...
	public class InputManager
	{
		...
		public InputManager()
		{
			if (instance == null) 
			{
				...
				MeshManager.Instance.CreatePlane("CurrentPlane",ResourceGroupManager.DefaultResourceGroupName ,plane.Plane, 20, 20, 1, 1, true, 1, 1, 1, Vector3.UnitZ);
		...
		public void ShowCurrentNode(Vector3 position, Piece thePiece, out int currentPosition)
		{
			...
			currentNode.IsVisible = (thePiece.GetPosition() != pos && pos != -1);  
