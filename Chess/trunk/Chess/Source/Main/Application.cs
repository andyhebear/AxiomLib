...
namespace Chess
{
	...
	public abstract class Application : IDisposable 
	{
		...
		protected virtual void ChooseSceneManager() 
		{
			...
			sceneManager = root.CreateSceneManager(SceneType.Generic, "ChessSM");
		}
        ...
        private static void loadCeGuiResources()
        {
            ...
            string[] imageSetFiles;
            
            if(System.IO.Directory.Exists("Media/Gui"))
             	imageSetFiles= System.IO.Directory.GetFiles(System.IO.Directory.GetCurrentDirectory() + @"Media/Gui", "*.imageset");
            else imageSetFiles= System.IO.Directory.GetFiles(System.IO.Directory.GetCurrentDirectory() + @"../../../../Media/Gui", "*.imageset");
