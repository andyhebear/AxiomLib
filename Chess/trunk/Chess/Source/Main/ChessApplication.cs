...
namespace Chess.Main
{
    ...
    public class ChessApplication : Chess.Application
    {
        ...
        protected override void ChooseSceneManager()
        {
            ...
            sceneManager = Root.Instance.CreateSceneManager(SceneType.Generic, "GameSM");
...
//HACK
        ...
        protected override void CreateScene()
        {
            ...
            plane.D = 0;
            MeshManager.Instance.CreatePlane( "board",ResourceGroupManager.DefaultResourceGroupName, plane, 160, 160, 1, 1, true, 1, 1, 1, Vector3.UnitZ );

			Texture texture = TextureManager.Instance.CreateManual( "RttTex",ResourceGroupManager.DefaultResourceGroupName,  TextureType.TwoD, 1024, 1024, 0, Axiom.Media.PixelFormat.R8G8B8, TextureUsage.RenderTarget );
            ...
            MeshManager.Instance.CreatePlane( "ReflectionPlane", ResourceGroupManager.DefaultResourceGroupName, movablePlane.Plane, 600, 600, 1, 1, true, 1, 1, 1, Vector3.UnitZ );
			...
			Texture texturea = TextureManager.Instance.CreateManual( "RttTexa", ResourceGroupManager.DefaultResourceGroupName, TextureType.TwoD, 1024, 1024, 0, Axiom.Media.PixelFormat.R8G8B8, TextureUsage.RenderTarget );
			RenderTarget rttTexa = texturea.GetBuffer().GetRenderTarget();
            {
                ...
                Material mata = (Material)MaterialManager.Instance.Create( "RttMata", ResourceGroupManager.DefaultResourceGroupName );
        ...
        public override void UpdateStats()
        {
            if ( showDebugOverlay )
            {
                ...
                element = OverlayManager.Instance.Elements.GetElement("Core/CurrentFPS");
                element.Text = string.Format( "Current FPS: {0:#.00}", Root.Instance.CurrentFPS );

                element = OverlayManager.Instance.Elements.GetElement("Core/Triangles");
        ...
        public virtual void preViewportUpdate( ViewportUpdateEventArgs evt )
        {
...
//                sceneManager.SetSkyBox( true, "Chess/Sunset", 50 );
        ...
        public virtual void postViewportUpdate( ViewportUpdateEventArgs evt )
        {
            if ( evt.Viewport == playerViewport )
            {
