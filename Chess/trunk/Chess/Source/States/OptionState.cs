	...
	public class OptionState: MenuState
	{
		...
		public OptionState()
		{
			if (instance == null) 
			{
				...
				// Add emenu items
				menuItems.Add(OverlayManager.Instance.Elements.GetElement("OptionMenu/Easy"));
                menuItems.Add(OverlayManager.Instance.Elements.GetElement("OptionMenu/Medium"));
                menuItems.Add(OverlayManager.Instance.Elements.GetElement("OptionMenu/Hard"));
			}
		}
