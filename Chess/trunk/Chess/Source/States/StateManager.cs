...
namespace Chess.States
{
    public class StateManager
    {
        ...
        private void UpdateCeGui()
        {
            ...
            //if (mouseMoved)
            {
                Axiom.Input.MouseEventArgs e1 = new Axiom.Input.MouseEventArgs(MouseButtons.Right, Axiom.Input.ModifierKeys.None, input.AbsoluteMouseX, input.AbsoluteMouseY, input.AbsoluteMouseZ, input.RelativeMouseX, input.RelativeMouseY, input.RelativeMouseZ * 0.001f);
