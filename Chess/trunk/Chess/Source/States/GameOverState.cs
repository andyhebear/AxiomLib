...
namespace Chess.States
{
	...
	public class GameOverState: MenuState
	{
		...
		{
			OverlayManager.Instance.Elements.GetElement("GameOverMenu/Outcome").Text = outcome;
            OverlayManager.Instance.Elements.GetElement("GameOverMenu/Winner").Text = winner;
		}
