	...
	public class PromotionMenuState: MenuState
	{
		...
		public PromotionMenuState()
		{
			if (instance == null) 
			{
				...
				// Add emenu items
                menuItems.Add(OverlayManager.Instance.Elements.GetElement("PromotionMenu/Queen"));
                menuItems.Add(OverlayManager.Instance.Elements.GetElement("PromotionMenu/Rook"));
                menuItems.Add(OverlayManager.Instance.Elements.GetElement("PromotionMenu/Bishop"));
                menuItems.Add(OverlayManager.Instance.Elements.GetElement("PromotionMenu/Knight"));
			}
		}
