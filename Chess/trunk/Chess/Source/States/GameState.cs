	...
	public class GameState: ChessState
	{
		...
		public override void MousePressed(object sender, MouseEventArgs e)
		{
			...
			{    
                ...
                //System.Collections.Generic.List<RaySceneQueryResultEntry> result = raySceneQuery.Execute
                System.Collections.Generic.IList<RaySceneQueryResultEntry> result = raySceneQuery.Execute();
