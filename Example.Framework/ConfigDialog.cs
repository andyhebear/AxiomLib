...
{
    public class ConfigDialog : SWF.Form, SWF.IMessageFilter
    {
        ...
        private void InitializeComponent()
        {
			...
			// cmdCancel
			// 
			this.cmdCancel.Anchor = SWF.AnchorStyles.Bottom;
			this.cmdCancel.DialogResult = SWF.DialogResult.Cancel;
			...
			// cmdOk
			// 
			this.cmdOk.Anchor = SWF.AnchorStyles.Bottom;
			this.cmdOk.DialogResult = SWF.DialogResult.OK;
