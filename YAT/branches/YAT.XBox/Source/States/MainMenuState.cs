    ...
    public class MainMenuState : MenuState
    {
        ...
        public MainMenuState()
        {
            if (instance == null)
            {
                ...
                // Add emenu items
                menuItems.Add(OverlayManager.Instance.Elements.GetElement("MainMenu/NewGame"));
                menuItems.Add(OverlayManager.Instance.Elements.GetElement("MainMenu/Help"));
                menuItems.Add(OverlayManager.Instance.Elements.GetElement("MainMenu/Highscores"));
