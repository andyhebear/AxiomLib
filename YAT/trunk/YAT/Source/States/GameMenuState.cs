    ...
    public class GameMenuState : MenuState
    {
        ...
        public GameMenuState()
        {
            if ( instance == null )
            {
                ...
                // Add emenu items
                menuItems.Add( OverlayManager.Instance.Elements.GetElement( "GameMenu/ResumeGame" ) );
                menuItems.Add( OverlayManager.Instance.Elements.GetElement( "GameMenu/AbortGame" ) );
            }
        }
