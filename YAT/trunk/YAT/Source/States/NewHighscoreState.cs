...
namespace YAT
{
    public class NewHighscoreState : MenuState
    {
        ...
        public override void Initialize()
        {
            ...
            OverlayManager.Instance.Elements.GetElement( "NewHighscoreMenu/YouPlacedText" ).Text = (
                "You placed " + placeStr + "..." );
        }
        ...
        public override void FrameStarted( float dt )
        {
            if ( needsUpdate )
            {
                ...
                element = OverlayManager.Instance.Elements.GetElement( "NewHighscoreMenu/Name" );
                element.Text = ( name + "_" );
