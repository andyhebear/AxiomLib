...
namespace YAT
{
    public class TetrisApplication : YAT.Application
    {
        ...
        protected override bool Setup()
        {
            ...
            this.configTitle = "YAT Configuration";
            this.logFile = "YAT.log";
            this.configFile = "EngineConfig.xml";
            this.renderWindowTitle = "YAT [Yet Another Tetris]";
        ...
        private bool OnFrameStart(FrameEventArgs e)
        {
        ...
        {
            scene = SceneManagerEnumerator.Instance.CreateSceneManager(SceneType.Generic, "genericSceneManager");
        }
        ...
        protected override void CreateViewports()
        {
            ...
            playerViewport.ShowOverlays=false;
            ...
            nextPieceViewport.ShowOverlays=false;
            ...
            menuViewport.ShowOverlays=true;
            menuOverlay = null;
        ...
        private void CreateMaterials()
        {
            ...
            {
                material = (Material)MaterialManager.Instance.Create("Brick" + ((int)(i + 1)).ToString(), ResourceGroupManager.DefaultResourceGroupName);
            ...
            for (int i = 0; i < Globals.NUM_PIECES; ++i)
            {
                material = (Material)MaterialManager.Instance.Create("BrickHighlight" + ((int)(i + 1)).ToString(), ResourceGroupManager.DefaultResourceGroupName);
        ...
        public override void UpdateStats()
        {
            if (showDebugOverlay)
            {
                OverlayElement element = OverlayManager.Instance.Elements.GetElement("Core/CurrentFPS");
        ...
        private void window_AfterViewportUpdate(ViewportUpdateEventArgs e)
        {
            ...
            if (e.Viewport == playerViewport)
            {
                ...
                // Hide debug overlay
                overlay = OverlayManager.Instance.GetByName("Core/DebugOverlay");
                if (overlay != null) overlay.Hide();
            }
        ...
        private void window_BeforeViewportUpdate(ViewportUpdateEventArgs e)
        {
            SceneNode root = scene.RootSceneNode;
