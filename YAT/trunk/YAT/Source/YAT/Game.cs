...
namespace YAT
{
    public class Game
    {
        ...
        public void Update(float dt)
        {
            ...
            {
                // Update statistics
                if (OverlayManager.Instance.Elements.GetElement("Statistics/Points") != null)
                    OverlayManager.Instance.Elements.GetElement("Statistics/Points").Text = "Points: " + mPoints.ToString();

                if (OverlayManager.Instance.Elements.GetElement("Statistics/Lines") != null)
                    OverlayManager.Instance.Elements.GetElement("Statistics/Lines").Text = "Lines: " + mLines.ToString();

                if (OverlayManager.Instance.Elements.GetElement("Statistics/Level") != null)
                    OverlayManager.Instance.Elements.GetElement("Statistics/Level").Text = "Level: " + mLevel.ToString();
            }
